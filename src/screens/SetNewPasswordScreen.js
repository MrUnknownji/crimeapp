...
import Icon from 'react-native-vector-icons/Ionicons'; // Import the Ionicons for the lock icon
        ...
        >
            <View style={styles.container}>
                ...
                <View style={styles.iconContainer}>
                    <Icon name="lock-closed-outline" size={40} color="#FFF" style={styles.icon} />
                </View>
