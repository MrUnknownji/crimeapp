...
import OTPTextInput from 'react-native-otp-textinput';  // Import the OTP text input library
        ...
        >
            <View style={styles.container}>
                ...
                <View style={styles.iconContainer}>
                    <Icon name="mail-outline" size={40} color="#FFF" style={styles.icon} />
                </View>

                {/* Title and Email Information */}
                <Text style={styles.title}>Password Reset</Text>
                <Text style={styles.subtitle}>
                    We sent a code to <Text style={styles.boldEmail}>splash@123gmail.com</Text>
                </Text>
                ...
                <Text style={styles.resendText}>
                    Didn't receive the email? <Text style={styles.resendLink}>Click to resend</Text>
                </Text>
